...
class Required{
    ...
    // public static function SwiftDB($version = null){
    //     require_once(ROOT_DIRECTORY ."/lib/Database/SwiftDB.php");
    //     return new static;
    // }

    // public static function ZeroSQL($version = null){
    //     require_once(ROOT_DIRECTORY ."/lib/database/v1/ZeroSQL.php");
    //     return new static;
    // }
     ...
     */
    public static function swiftForm($version = null){
        if ($version == "bjsc") {
            echo '<script src="'.BASE_URL.'assets/js/plugins/swift-submit-bjsc.js"></script>';
        }
        else {
            echo '<script src="'.BASE_URL.'assets/js/plugins/swift-submit-v2.js"></script>';
        }
        return new static;
    }
